...
public class ViewAccountBalanceCommand : ICommand, IDisposable
{
    private readonly User? _user;
    private readonly SQLService.Service _service;
    private NpgsqlConnection? _connection;

    public ViewAccountBalanceCommand(string userName, string password)
    {
    ...
    public void Execute()
    {
        if (_user != null) _ = _service.GetBalanceAsync(_user);
    }
